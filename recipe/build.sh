...
cp pkgs/sagemath-standard/sage/ext_data/notebook-ipython/logo.svg $PREFIX/jupyter/kernels/sagemath/
cp pkgs/sagemath-standard/sage/ext_data/notebook-ipython/logo-64x64.svg $PREFIX/jupyter/kernels/sagemath/
